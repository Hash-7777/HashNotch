...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-909%20passing-8FBAFF?style=flat-square&labelColor=0B0C10" alt="909 automated checks passing">
...
**Verified, not asserted.** 909 automated checks run before every push — the parsers, the geometry, the privacy rules, and the arithmetic behind every readout. Every commit is signed.
...
1. Download the disk image — `HashNotch-1.3.0.dmg` — from [Releases](https://github.com/Hash-7777/HashNotch/releases/latest) and open it. Drag **HashNotch** onto the **Applications** folder shown beside it, then eject the disk image.
